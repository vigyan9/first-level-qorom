function isNumeric(scanner) {
    return "0" <= scanner && scanner <= "9";
  }

function isWhitespace(scanner) {
      return scanner === " " || scanner === "\t";
    }

  function isAlpha(scanner) {
    return ("a" <= scanner && scanner <= "z") || ("A" <= scanner && scanner <= "Z");
  }
